...
with mp_face_mesh.FaceMesh(
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            iris_position, ratio = eyes_pos(center_right, mesh_points[R_H_RIGHT], mesh_points[R_H_LEFT][0])
            # print(iris_position)
            cv.putText(frame,f'iris pos: {iris_position}, {ratio:.2f}', (30,30), cv.FONT_HERSHEY_PLAIN, 1.2, (0,255,0), 1, cv.LINE_AA)
        cv.imshow('img', frame)
        key = cv.waitKey(1)
